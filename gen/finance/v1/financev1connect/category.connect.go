...
const (
	...
	CategoryServiceName = "finance.v1.CategoryService"
)
...
const (
	...
	// ListCategories RPC.
	CategoryServiceListCategoriesProcedure = "/finance.v1.CategoryService/ListCategories"
)

// CategoryServiceClient is a client for the finance.v1.CategoryService service.
...
// NewCategoryServiceClient constructs a client for the finance.v1.CategoryService service. By
...
func NewCategoryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CategoryServiceClient {
	...
	categoryServiceMethods := v1.File_finance_v1_category_proto.Services().ByName("CategoryService").Methods()
...
// ListCategories calls finance.v1.CategoryService.ListCategories.
...
// CategoryServiceHandler is an implementation of the finance.v1.CategoryService service.
...
func NewCategoryServiceHandler(svc CategoryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/finance.v1.CategoryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCategoryServiceHandler) ListCategories(context.Context, *connect.Request[v1.ListCategoriesRequest]) (*connect.Response[v1.ListCategoriesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finance.v1.CategoryService.ListCategories is not implemented"))
}
